    ...
    createDeclaration: async (req, res) => {
        try {
            ...
            const data = {
                ...
                packageCount: body.packageCount ? parseFloat(body.packageCount) : null,
                ...
                value: body.value,
                packageCountDeclared: body.packageCountDeclared,
    ...
    updateDeclaration: async (req, res) => {
        try {
            ...
            const data = {
                ...
                productName: body.productName,
                orderCode: body.orderCode,
                packageCount: body.packageCount ? parseFloat(body.packageCount) : undefined,
